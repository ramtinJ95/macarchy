...
authoritative provider ownership, pending recovery, and bounded skhd process
...
validated inputs, generated bytes, provider ownership, and process presence;
it does not claim complete in-memory runtime equivalence because skhd exposes
no query for its effective binding table.
