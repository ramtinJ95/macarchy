...
struct YabaiConfigurationTests {
  ...
  func packagedDefaultsRenderDeterministically() throws {
    ...
    #expect(first.renderedConfiguration.contains("top_padding 0"))
    #expect(first.renderedConfiguration.contains("bottom_padding 5"))
    #expect(first.renderedConfiguration.contains("window_gap 5"))
    #expect(first.renderedConfiguration.contains("app='^Karabiner-Elements$' manage=off"))
    #expect(first.renderedConfiguration.contains("app='^QuickTime Player$' manage=off"))
    #expect(first.renderedConfiguration.contains("title='^SFML$' manage=off"))
    #expect(first.renderedConfiguration.contains("title='Our Love Story$' manage=off"))
    #expect(first.renderedConfiguration.contains("title='^Software Renderer$' manage=off"))
