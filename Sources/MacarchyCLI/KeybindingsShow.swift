...
struct KeybindingsShowCommandLoader: Sendable {
  ...
  func load(
    ...
    case .converged:
      heading = "Managed Keybindings"
      stateMessage =
        "Generated bytes, provider ownership, and skhd process evidence agree. "
        + "skhd does not expose its complete in-memory binding table."
      rowDescription = "effective managed shortcuts"
      commandDescription = "Effective command"
    case .clean:
      heading = "Desired Managed Keybindings"
      stateMessage = "Not configured. Showing desired managed bindings."
      rowDescription = "desired shortcuts"
      commandDescription = "Desired command"
    case .drifted:
      heading = "Desired Managed Keybindings"
      stateMessage = "Drift detected: \(effectiveState.statusMessage) Showing desired bindings."
      rowDescription = "desired shortcuts"
      commandDescription = "Desired command"
    case .externallyManaged:
      heading = "Desired Managed Keybindings"
      stateMessage =
        "Externally managed: reviewed adoption is required. Showing proposed managed bindings, "
        + "not the authoritative external source."
      rowDescription = "proposed managed shortcuts"
      commandDescription = "Proposed managed command"
    case .recoveryRequired:
      heading = "Desired Managed Keybindings"
      stateMessage = "Recovery required: \(effectiveState.statusMessage) Showing desired bindings."
      rowDescription = "desired shortcuts"
      commandDescription = "Desired command"
    case .blocked:
      heading = "Desired Managed Keybindings"
      stateMessage =
        "Managed state is blocked: \(effectiveState.statusMessage) Showing desired bindings."
      rowDescription = "desired shortcuts"
      commandDescription = "Desired command"
    }
    return KeybindingsPopupContent(
